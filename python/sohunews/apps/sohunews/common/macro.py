...
SOHUNEWS_API = {
    ...
    "news": "http://api.k.sohu.com/api/channel/v4/news.go?channelId={0}&num=20&page=1&imgTag=1&showPic=1&picScale=2&rt=json&pull=0&visitTime={1}&more=0&lastPullTime=0&net=wifi&from=channel&p1={2}&gid={3}&pid={4}"
}
